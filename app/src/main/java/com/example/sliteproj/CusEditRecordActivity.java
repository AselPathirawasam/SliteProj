...
public class CusEditRecordActivity extends AppCompatActivity {
    ...
    private String id,fname,lname,nic,cnumber,email,password,cpassword, addTimeStamp, updateTimeStamp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cusactivity_edit_record);

        actionBar = getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setDisplayShowHomeEnabled(true);

        pd = new ProgressDialog(CusEditRecordActivity.this);
        ...
        cpassword = intent.getStringExtra("CPASSWORD");
        ...
        if (editMode) {
            ...
            pFnameEt.setText(fname);
            pLnameEt.setText(lname);
            pNicEt.setText(nic);
            pCnumberEt.setText(cnumber);
            pEmailEt.setText(email);
            pPasswordEt.setText(password);
            pCpasswordEt.setText(cpassword);
        ...
        saveInfoBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    getData();
                    startActivity(new Intent(CusEditRecordActivity.this, CusMainActivity.class));
                    Toast.makeText(CusEditRecordActivity.this, "Updated Successfully!", Toast.LENGTH_SHORT).show();
